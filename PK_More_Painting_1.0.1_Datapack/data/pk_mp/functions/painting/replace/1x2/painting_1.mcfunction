...
data modify entity @e[type=item_frame,tag=pkmp_current_to_init,limit=1] Item.tag.map set value 16110041
...
data modify entity @e[type=item_frame,tag=pkmp_current_to_init,limit=1] Item.tag.map set value 16110042
tag @e[type=item_frame,tag=pkmp_current_to_init] remove pkmp_current_to_init