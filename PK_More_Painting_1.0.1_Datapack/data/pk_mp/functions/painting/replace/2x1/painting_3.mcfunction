...
data modify entity @e[type=item_frame,tag=pkmp_current_to_init,limit=1] Item.tag.map set value 16110071
...
data modify entity @e[type=item_frame,tag=pkmp_current_to_init,limit=1] Item.tag.map set value 16110072
tag @e[type=item_frame,tag=pkmp_current_to_init] remove pkmp_current_to_init